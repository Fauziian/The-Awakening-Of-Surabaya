...
public class Story1 extends JPanel {
    ...
    private final String[] imgStory = {
        "asset/story/1.png", "asset/story/2.png", "asset/story/3.png",
        "asset/story/4.png", "asset/story/5.png", "asset/story/6.png",
        "asset/story/7.png", "asset/story/8.png", "asset/story/9.png",
        "asset/story/10.png"
    };
    ...
    public Story1(Runnable onSelesai) {
        setLayout(null);
