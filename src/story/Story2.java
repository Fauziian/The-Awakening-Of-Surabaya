...
public class Story2 extends JPanel {

    private final String[] imgStory = {
        "asset/story/11.png", "asset/story/12.png", "asset/story/13.png",
        "asset/story/14.png", "asset/story/15.png"
    };
    ...
    public Story2(Runnable onSelesai) {
        setLayout(null);
